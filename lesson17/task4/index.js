...
console.log(sayName.call(student));

// вызовите ф-цию sayName так, чтобы в консоль вывелось имя 'Bruce' (используйте другой объект)
// ... your code here
console.log(sayName.call({ name: 'Bruce' }));
...
const getPopul = getPopulation.call(country, 43000);
console.log(getPopul);
// getPopul.call(country, )
